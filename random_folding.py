...
dx, dy = 1.0, 1.0 # DISTANCE TO PLACE
...
for k in range(N):
    def initialize(fabric_size = 2, desk_friction = 5.0, tension_stiffness = 10.0, compression_stiffness = 10.0, cloth_self_friction = 2.0):
        '''
    ...
    def select_single(mesh, x, y, num_cuts = NOC):
        '''
    ...
    def fold_cloth(dx, dy, dz, start_frame = 5, mid_frame = MID_FRAME[k], end_frame = END_FRAME[k]):
        '''
